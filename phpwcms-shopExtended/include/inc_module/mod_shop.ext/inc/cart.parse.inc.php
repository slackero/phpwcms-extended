...
// calculate discount
if(empty($_shopPref['shop_pref_discount']['discount']) || empty($_shopPref['shop_pref_discount']['percent']) || ($_shopPref['shop_pref_discount']['amount'] > 0 && $subtotal['float_net'] < $_shopPref['shop_pref_discount']['amount'])) {
	...
	if(!empty($_shopPref['shop_pref_discount']['freeshipping'])) {
