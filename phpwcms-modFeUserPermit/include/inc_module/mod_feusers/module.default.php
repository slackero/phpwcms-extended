...
$_module_fe_search		= false; // use it for search too

if(!isset($phpwcms['reserved_alias']) || !is_array($phpwcms['reserved_alias'])) {
	$phpwcms['reserved_alias'] = array();
}

$phpwcms['reserved_alias'][] = 'feuser-logout';
