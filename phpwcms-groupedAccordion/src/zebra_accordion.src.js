 ...
 *  Little enhancement to define switch and content selector based on settings by Oliver Georgi
 *
 *  @author     Stefan Gabos <contact@stefangabos.ro>
 *  @version    1.2.2.1 (last revision: December 16, 2013)
...
;(function($) {
    ...
    $.Zebra_Accordion = function(el, options) {
        ...
        var defaults = {
			...
			switch: 				'dt',						// element which should be triggered as accordion switch
			
			content: 				'dd',						// element which should be triggered as the accordion content section
        ...
        var init = function() {
            ...
            $titles = $(plugin.settings.switch, $element);    // references to the title elements
            $blocks = $(plugin.settings.content, $element);    // references to the content blocks
